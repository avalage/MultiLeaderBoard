...
namespace BeatLeader.Components {
    internal class MapDifficultyPanel : ReeUIComponentV2 {
        ...
        [UIComponent("bg"), UsedImplicitly] private ImageView _background = null!;
        ...
        protected override void OnInitialize() {
            ...
            IsActive = false;
            _background.material = BeatLeaderDarkGoldTheme.Enabled ? GameResources.UINoGlowMaterial : null;
            if (BeatLeaderDarkGoldTheme.Enabled) {
                _background.sprite = GameResources.Sprites.RoundRect;
            }
            BeatLeaderDarkGoldTheme.ApplyPanel(_background, BeatLeaderDarkGoldTheme.DifficultyPanelColor);
