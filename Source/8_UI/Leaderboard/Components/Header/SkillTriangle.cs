...
namespace BeatLeader.Components {
    internal class SkillTriangle : ReeUIComponentV2 {
        ...
        private void InitializeLabels() {
            ...
            BeatLeaderDarkGoldTheme.ApplyTextColor(_textComponentA, BeatLeaderDarkGoldTheme.TextPrimary);
            BeatLeaderDarkGoldTheme.ApplyTextColor(_textComponentB, BeatLeaderDarkGoldTheme.TextPrimary);
            BeatLeaderDarkGoldTheme.ApplyTextColor(_textComponentC, BeatLeaderDarkGoldTheme.TextPrimary);
        }
        ...
        private void InitializeMaterial() {
            ...
            BeatLeaderDarkGoldTheme.ApplyGoldMaterial(_materialInstance, BeatLeaderDarkGoldTheme.WithAlpha(BeatLeaderDarkGoldTheme.AccentGold, 0.92f));
            _triangleImage.material = _materialInstance;
            if (BeatLeaderDarkGoldTheme.Enabled) {
                _triangleImage.color = BeatLeaderDarkGoldTheme.WithAlpha(BeatLeaderDarkGoldTheme.AccentYellow, 0.92f);
            }
            UpdateMaterialProperties();
        }
