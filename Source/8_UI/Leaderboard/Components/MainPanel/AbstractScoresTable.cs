...
namespace BeatLeader.Components {
    internal abstract class AbstractScoresTable<T> : ReeUIComponentV2 where T : AbstractScoreRow {
        ...
        [UIComponent("Root"), UsedImplicitly]
        private protected ImageView _rootBackground;
        ...
        protected override void OnInitialize() {
            ...
            _rootBackground.material = BeatLeaderDarkGoldTheme.Enabled ? GameResources.UINoGlowMaterial : null;
            if (BeatLeaderDarkGoldTheme.Enabled) {
                _rootBackground.sprite = GameResources.Sprites.RoundRect;
            }
            BeatLeaderDarkGoldTheme.ApplyPanel(_rootBackground, BeatLeaderDarkGoldTheme.ScoreTableBackgroundColor);
            SetupLayout();
        }
