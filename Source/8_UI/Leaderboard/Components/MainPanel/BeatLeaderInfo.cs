...
namespace BeatLeader.Components {
    internal class BeatLeaderInfo : AbstractReeModal<object> {
        ...
        private static string OutdatedModVersionText => $"<color={BeatLeaderDarkGoldTheme.ErrorRedHtml}><bll>ls-mod-is-outdated</bll>!";
        private static string UpdatedModVersionText => $"<color={BeatLeaderDarkGoldTheme.SuccessGreenHtml}><bll>ls-mod-is-up-to-date</bll>!";
        ...
        private static void UpdatePlaylistButton(Button button, PlaylistsManager.PlaylistType playlistType, PlaylistsManager.PlaylistState playlistState) {
            var prefix = playlistState switch {
                PlaylistsManager.PlaylistState.NotFound => $"<color={BeatLeaderDarkGoldTheme.ErrorRedHtml}>",
                PlaylistsManager.PlaylistState.Outdated => $"<color={BeatLeaderDarkGoldTheme.AccentYellowHtml}>",
                PlaylistsManager.PlaylistState.UpToDate => $"<color={BeatLeaderDarkGoldTheme.SuccessGreenHtml}>",
                _ => ""
            };
