...
namespace BeatLeader.Components {
    internal class MapTypeSelector : ReeUIComponentV2 {
        ...
        private static string UndecidedColor => BeatLeaderDarkGoldTheme.TextSecondaryHtml;
        private static string InactiveColor => BeatLeaderDarkGoldTheme.TextMutedHtml;
        private static string ActiveColor => BeatLeaderDarkGoldTheme.AccentYellowHtml;
