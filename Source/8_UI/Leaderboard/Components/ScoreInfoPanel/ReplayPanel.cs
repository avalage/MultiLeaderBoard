    ...
    internal class ReplayPanel : ReeUIComponentV2 {
        ...
        protected override void OnInitialize() {
            ...
            _downloadButtonImage = new Image {
                ...
                Color = BeatLeaderDarkGoldTheme.WithAlpha(BeatLeaderDarkGoldTheme.SelectedIconColor, 0.85f),
                PreserveAspect = true,
                Skew = UIStyle.Skew
            }.With(x => {
        ...
        private static string FormatFailString(string failReason) {
            return $"<color={BeatLeaderDarkGoldTheme.ErrorRedHtml}>Fail: {failReason}</color>";
        }
