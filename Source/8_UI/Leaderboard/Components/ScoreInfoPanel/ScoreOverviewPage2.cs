...
namespace BeatLeader.Components {
    internal class ScoreOverviewPage2 : ReeUIComponentV2 {
        ...
        private static string XColor => BeatLeaderDarkGoldTheme.WarningOrangeHtml;
        private static string YColor => BeatLeaderDarkGoldTheme.SuccessGreenHtml;
        private static string ZColor => BeatLeaderDarkGoldTheme.AccentYellowHtml;
