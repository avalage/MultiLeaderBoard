...
namespace BeatLeader.Components {
    internal class ScoreInfoPanel : AbstractReeModal<(Score, ReplayerViewNavigatorWrapper)> {
        ...
        protected override void OnInitialize() {
            ...
            LeaderboardEvents.ScorePerformancePointsUpdatedEvent += OnScorePerformancePointsUpdated;
        ...
        private void OnScorePerformancePointsUpdated(Score score) {
            if (_score == null || _score.id != score.id) {
                return;
            }

            _scoreOverviewPage1.SetScore(_score);
        }
