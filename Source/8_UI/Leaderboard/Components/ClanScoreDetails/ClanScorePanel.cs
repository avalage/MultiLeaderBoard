...
namespace BeatLeader.Components {
    ...
    internal class ClanScorePanel : AbstractReeModal<ClanScorePanelContext> {
        ...
        protected override void OnInitialize() {
            ...
            BeatLeaderDarkGoldTheme.ApplyPanel(_paginationPanel, BeatLeaderDarkGoldTheme.PanelTransparent);
            BeatLeaderDarkGoldTheme.ApplyPanel(_middlePanel, BeatLeaderDarkGoldTheme.ScorePanelColor);
            BeatLeaderDarkGoldTheme.ApplyPanel(_bottomPanel, BeatLeaderDarkGoldTheme.BottomPanelColor);
        ...
        private static Color HoveredColor => BeatLeaderDarkGoldTheme.HoveredPaginationColor;
        private static Color ActiveColor => BeatLeaderDarkGoldTheme.ActivePaginationColor;
        private static Color InactiveColor => BeatLeaderDarkGoldTheme.InactiveIconColor;
