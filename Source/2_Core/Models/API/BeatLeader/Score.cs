...
namespace BeatLeader.Models {
    public class Score : IScoreRowContent, IReplayHashProvider {
        ...
        public bool withPp;
        [JsonIgnore]
        public float scoreSaberPp;
        [JsonIgnore]
        public bool withScoreSaberPp;
        [JsonIgnore]
        public float scoreSaberFcPp;
        [JsonIgnore]
        public bool withScoreSaberFcPp;
        [JsonIgnore]
        public float accSaberAp;
        [JsonIgnore]
        public bool withAccSaberAp;
        [JsonIgnore]
        public bool displayBeatLeaderPp = true;
        public float fcPp;
        ...
        public bool ContainsValue(ScoreRowCellType cellType) {
            return cellType switch {
                ...
                ScoreRowCellType.PerformancePoints => HasVisibleBeatLeaderPp || withScoreSaberPp || withAccSaberAp,
        ...
        public object? GetValue(ScoreRowCellType cellType) {
            return cellType switch {
                ...
                ScoreRowCellType.PerformancePoints => PerformancePoints,
        ...
        #region Performance points

        [JsonIgnore]
        public bool HasVisibleBeatLeaderPp => withPp && displayBeatLeaderPp;

        [JsonIgnore]
        public ScoreRowPerformancePoints PerformancePoints => new(
            pp,
            HasVisibleBeatLeaderPp,
            scoreSaberPp,
            withScoreSaberPp,
            accSaberAp,
            withAccSaberAp
