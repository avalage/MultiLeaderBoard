    ...
    public class Score : IScoreRowContent, IReplayHashProvider {
        ...
        public bool ContainsValue(ScoreRowCellType cellType) {
            return cellType switch {
                ...
                ScoreRowCellType.PerformancePoints => HasVisibleBeatLeaderPp || withScoreSaberPp,
        ...
        [JsonIgnore]
        public ScoreRowPerformancePoints PerformancePoints => new(pp, HasVisibleBeatLeaderPp, scoreSaberPp, withScoreSaberPp);
