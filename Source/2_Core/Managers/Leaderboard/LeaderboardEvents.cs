...
#nullable disable
    internal static class LeaderboardEvents {
        ...
        #region ScorePerformancePointsUpdated

        public static event Action<Score> ScorePerformancePointsUpdatedEvent;

        public static void NotifyScorePerformancePointsUpdated(Score score) {
            ScorePerformancePointsUpdatedEvent?.Invoke(score);
        }
